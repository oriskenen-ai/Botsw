...
// Format +267XXXXXXXXX for Telegram display (Botswana)
function formatPhone(phoneNumber) {
    if (!phoneNumber) return phoneNumber;
    // Handle Botswana +267 format
    if (phoneNumber.startsWith('+267'))  return phoneNumber.slice(1); // +267... → 267...
    if (phoneNumber.startsWith('267'))   return phoneNumber; // 267... → 267...
    if (!phoneNumber.startsWith('2'))    return '267' + phoneNumber; // bare digits → 267...
    return phoneNumber;
}
...
`;
                ...
                await bot.sendMessage(chatId, `
👋 *Welcome to InnBucks Botswana Loan Platform!*
...
// ── Serve the InnBucks Botswana HTML ──
...
// ==========================================
app.listen(PORT, () => {
    console.log(`\n💎 MTN MOMO BOTSWANA LOAN PLATFORM`);
    console.log(`==================================`);
